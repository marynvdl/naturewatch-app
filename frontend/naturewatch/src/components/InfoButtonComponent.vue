...
const cardData = ref([
  ...
  },
  {
    ...
    icon: 'mdi-barley',
    content:
      'We sourced data from the <a href="https://glad.umd.edu/dataset/croplands" target="_blank">Global Cropland Expansion in the 21st Century</a> dataset. We are currently working to expand our layers with information from other years',
  },
  {
    title: 'Rivers',
    subtitle: 'Coming soon',
